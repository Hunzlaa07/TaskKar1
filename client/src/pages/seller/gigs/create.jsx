...
function CreateGigs() {
  ...
  const inputClassName =
    "block p-4 w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500";
  const labelClassName = "mb-2 text-lg font-medium text-green-700";
  ...
  const addGig = async () => {
    ...
    if (
      ...
      try {
        ...
        console.error("Failed to create gig:", err.message);
      }
    }
  };
  ...
  return (
    <div className="min-h-[80vh] my-10 mt-0 px-32 ">
      <h1 className="text-6xl text-green-700 mb-5 font-bold">Create a new Gig</h1>
      <h3 className="text-3xl text-green-700 mb-5">
