  ...
  return (
    <div className="h-[680px] relative bg-cover">
      ...
      <div className="z-10 relative w-[650px] flex justify-center flex-col h-full gap-5 ml-20">
        <h1 className="text-[#2d7a34] font-bold text-5xl leading-snug">
          Discover top-notch <br />&nbsp;
          <i>Task Doers</i>
          <br />
          for your Tasks on TaskKar
        </h1>
        <div className="flex align-middle">
          <div className="relative">
            ...
            <input
              ...
              placeholder={`Try "Household Tasks"`}
              value={searchData}
        ...
        <div className="text-white flex gap-4">
          ...
          <ul className="flex gap-5">
            <li
              ...
              onClick={() => router.push("/search?q=Household Tasks")}
            >
              Household Tasks
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Cleaning Services")}
            >
             Cleaning Services
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Delivery Services")}
            >
            Delivery Services
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Event Planning")}
            >
            Event Planning
            </li>
          </ul>
